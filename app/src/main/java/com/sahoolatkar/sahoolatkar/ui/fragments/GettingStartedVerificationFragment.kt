 ...
 * Use the [GettingStartedVerificationFragment.newInstance] factory method to
...
class GettingStartedVerificationFragment : Fragment() {
    ...
    companion object {
         ...
         * @return A new instance of fragment GettingStartedVerificationFragment.
         */
        // TODO: Rename and change types and number of parameters
        @JvmStatic fun newInstance(param1: String, param2: String) =
                GettingStartedVerificationFragment().apply {
