 ...
 * Use the [GettingStartedRegistrationFragment.newInstance] factory method to
...
class GettingStartedRegistrationFragment : Fragment() {
    ...
    companion object {
         ...
         * @return A new instance of fragment GettingStartedRegistrationFragment.
         */
        // TODO: Rename and change types and number of parameters
        @JvmStatic fun newInstance(param1: String, param2: String) =
                GettingStartedRegistrationFragment().apply {
